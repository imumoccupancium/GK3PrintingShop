    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 text-center">
          <h3 className="text-sm md:text-base font-semibold text-slate-600 mb-2">ABOUT GK3</h3>
          <h2 className="text-4xl md:text-5xl font-bold text-blue-600 mb-4">About GK3 Printing Shop</h2>
          <h3 className="text-2xl md:text-3xl font-bold text-slate-900">
            We Print To Impress, <span className="text-blue-600">Every Single Time</span>
          </h3>
        </div>
